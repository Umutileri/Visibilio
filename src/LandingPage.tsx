...
const translations: Record<Language, Record<string, string>> = {
  ...
  TR: {
    product: "Ürün", how: "Nasıl çalışır", evidence: "Kanıt", retest: "Yeniden test", workspace: "Uygulamayı aç", start: "Ücretsiz başla", heroAnalyze: "Sayfayı analiz et", seeHow: "Akışı gör",
    heroEyebrow: "Gerçek tarayıcı verisiyle web arayüzü kalitesi.", heroTitle: "Arayüz sorunlarını bulun.<br /><em>Görünen sorunları düzeltin.</em>",
    heroBody: "Gerçek bir sayfayı tarayın, ölçülebilir UI sorunlarını görün, kanıtı anlayın ve yaptığınız düzeltmeyi yeniden test edin.", finding: "Bulgu", contentExceeds: "İçerik görünüm alanını aşıyor", mobile: "mobil", measuredBrowser: "Gerçek tarayıcıda ölçüldü.",
    ...
    urlBody: "Bir sayfa yapıştırın, kontrolü çalıştırın ve üzerinde harekete geçebileceğiniz net bir bulgu alın.", urlLabel: "Web sitesi URL'si", analyze: "Analiz et", urlNote: "Ücretsiz başla · sayfa denetiminize bağlı kalır.",
